...
@bottle.route('/form.html')
def script_file():
  script_js_file = bottle.static_file("form.html", root=".")
  return script_js_file

@bottle.route('/submit.html')
def script_file14():
  script_js_file = bottle.static_file("submit.html", root=".")
  return script_js_file

@bottle.route('/style.css')
def script_file2():
  script_js_file = bottle.static_file("style.css", root=".")
  return script_js_file

@bottle.route('/exercise.html')
def index2():
  html_file = bottle.static_file("exercise.html", root=".")
  return html_file

@bottle.route('/meditation.html')
def index3():
  html_file = bottle.static_file("meditation.html", root=".")
  return html_file

@bottle.route('/mini_games.html')
def index4():
  html_file = bottle.static_file("mini_games.html", root=".")
  return html_file

@bottle.route('/motivation.html')
def index5():
  html_file = bottle.static_file("motivation.html", root=".")
  return html_file

@bottle.route('/playlist.html')
def index6():
  html_file = bottle.static_file("playlist.html", root=".")
  return html_file

@bottle.route('/self-care_tasks.html')
def index7():
  html_file = bottle.static_file("self-care_tasks.html", root=".")
  return html_file
